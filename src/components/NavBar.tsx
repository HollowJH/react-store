...
export function NavBar() {
  ...
  return (
    ...
    pt-[20px] pb-0 flex flex-col items-center">
      <div className="w-[1080px] flex grow justify-between items-center">
        ...
        <form className="w-[33%] flex items-center grow justify-center">
          <input
            className="w-full h-[60px] border-none rounded-[15px] 
            p-2.5 my-0 mx-5 text-[14px] text-center"
            type="text"
            placeholder="Search"
            id="search"
            ref={search}
        ...
        <ul className="w-[33%] flex items-center grow justify-end list-none">
          <li id="facebook" className="w-[50px] h-[50px]">
            <Link className="w-[50px] h-[50px]" to="https://facebook.com">
              <img
                className="h-[50px] w-[50px] p-2.5"
          ...
          <li id="instagram" className="w-[50px] h-[50px]">
            <Link className="w-[50px] h-[50px]" to="https://instagram.com">
              <img
                className="h-[50px] w-[50px] p-2.5"
      ...
      <nav id="navbar" className="w-[1080px] py-[15px] px-5 bg[#ff3b3c] 
      flex justify-between list-none text-[14px]">
